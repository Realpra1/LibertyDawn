...
- Phase: `CNC87 spec complete; speccer 2 active`
...
| 2 | CNC-40 Adaptive specialists | `agent/round-20260807-cnc40-adaptive-specialists` | `.worktrees/coordinated-cnc/20260807-bug-polish-02/workers/worker-2-cnc40` | claimed; speccing active; packet `COORDINATED-CNC-ROUNDS/20260807-bug-polish-02/TASK-PACKET-2.md` | `roles/speccer-2/process.json` running | | | |
