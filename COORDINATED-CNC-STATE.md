...
|---|---|---|---|---|---|---|
| RC1 | product `394ae5eeadff`; receipt `ffb841b48750` | CNC-87 `5170183fb882`; CNC-40 `40ed5926864c`; CNC-41 `418786381f64`; CNC-42 `260d10e9654c`; CNC-44 `df9cd6e12fd5` | receipts CNC-87 `4c75f395`, CNC-40 `bd7e2812`, CNC-44 `1ead96e9`; CNC-42 repair `b6e7eecf`; CNC-41 assignment `a6d55734` | conflict-free merge; Debug/Release, interface/Lua, CNC YAML/maps, 512 tests, and release PR Linux/Windows CI passed | CNC-87, CNC-40, and CNC-44 passed; CNC-41 repair active; CNC-42 repair awaiting CI/review | testing |
