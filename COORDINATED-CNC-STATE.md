...
| 2 | CNC-39A Engineer/commando target coordination | `agent/round-20260806-cnc39a-rc2-repair` | `.worktrees/coordinated-cnc/20260806-bug-polish-01/integration/combined-worker-2-cnc39a` | `reviewed` (`WORKER-2-CNC-39A/STATE.md`) | `roles/combined-worker-2-rc2/process.json` running | [#80](https://github.com/Realpra1/LibertyDawn/pull/80) at `937ef02048` | `blocked`; one required save/load response completed with exact-head CI and reload evidence (`REVIEW-2.md`) | `RC2 combined testing active` |
| 3 | CNC-43 MCV crush flavor | `agent/round-20260806-cnc43-rc2-repair` | `.worktrees/coordinated-cnc/20260806-bug-polish-01/integration/combined-worker-3-cnc43` | `reviewed` (`WORKER-3-CNC-43/STATE.md`) | `roles/combined-worker-3-rc2/process.json` running | [#78](https://github.com/Realpra1/LibertyDawn/pull/78) at `b229612791` | `ready with one fix`; one permitted evidence response complete (`REVIEW-3.md`) | `RC2 combined testing active` |
| 4 | CNC-43A Flame Tank balance | `agent/round-20260806-cnc43a-rc2-repair` | `.worktrees/coordinated-cnc/20260806-bug-polish-01/integration/combined-worker-4-cnc43a` | `reviewed` (`WORKER-4-CNC-43A/STATE.md`) | `roles/combined-worker-4-rc2/process.json` running | [#79](https://github.com/Realpra1/LibertyDawn/pull/79) at `ade3f9d325` | `ready with one fix`; one permitted evidence response complete (`REVIEW-4.md`) | `RC2 combined testing active` |
| 5 | CNC-51 Transport-helicopter unload recovery and threat-safe landing | `agent/round-20260806-cnc51-rc2-repair` | `.worktrees/coordinated-cnc/20260806-bug-polish-01/integration/combined-worker-5-cnc51` | `Complete - testing` (`WORKER-5-CNC-51/STATE.md`) | `roles/combined-worker-5-rc2/process.json` running | [#81](https://github.com/Realpra1/LibertyDawn/pull/81) at `72dad573af` (product `cb6a05d5a3`) | `ready with one fix`; moving-aircraft closing envelope response complete, exact-head CI passed | `RC2 combined testing active` |
