...
- Match Commenters read assigned game artifacts and optionally `.agents/references/LIBERTY-DAWN-DESIGN.md`; they do not read implementation context. Policy Reviewers read only that design document plus their assigned factual or proposed-policy narrative, apart from role instructions and a path-only job envelope.
