...
- For substantial non-autonomous coding work, use the portable repository skill at `.agents/skills/coding-workflow/SKILL.md`. Do not combine it with `autonomous-cnc-coding` in the same run.
