...
if not defined ai_map (
	...
	echo Usage: launch-ai-debug.cmd ["C:\path\to\Empire-Earth.oramap"] [fastest^|max] [benchmark-prefix] [save-tick] [save-name]
