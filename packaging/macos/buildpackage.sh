	...
	echo '
	   tell application "Finder"
	     tell disk "'OpenRA'"
	           ...
	           set position of item "'OpenRA - Tiberian Dawn.app'" of container window to {220, 106}
	           set position of item "Applications" of container window to {420, 106}
...
if [ -n "${MACOS_DEVELOPER_USERNAME}" ] && [ -n "${MACOS_DEVELOPER_PASSWORD}" ] && [ -n "${MACOS_DEVELOPER_IDENTITY}" ] && [ -n "${MACOS_DEVELOPER_TEAM_ID}" ]; then
