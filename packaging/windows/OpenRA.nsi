...
Section "-Reg" Reg
	...
	; Remove registrations left by older multi-mod LibertyDawn packages.
	DeleteRegKey HKLM "Software\Classes\openra-ra-${TAG}"
	DeleteRegKey HKLM "Software\Classes\openra-d2k-${TAG}"
	DeleteRegKey HKLM "Software\Classes\discord-699222659766026240"
	DeleteRegKey HKLM "Software\Classes\discord-712711732770111550"
...
Section "Game" GAME
	...
	Delete "$INSTDIR\OpenRA.Mods.D2k.dll"
...
;***************************
LangString DESC_GAME ${LANG_ENGLISH} "LibertyDawn Tiberian Dawn, engine and dependencies"
