...
Cost-adjusted matchups — Best: Apache Longbow (x4), Orca (x2). Worst: APC (cannot
...
Cost-adjusted matchups — Best: APC (immune), Artillery (immune), Chemical Tank
(immune), Chemical Warrior (immune), Commando (immune). Worst: SAM Site (/12),
Advanced Guard Tower (/8), Mammoth Tank (/12), Mobile S.A.M. (/4), Orca (/2).
...
Cost-adjusted matchups — Best: APC (immune), Artillery (immune), Chemical Tank
(immune), Chemical Warrior (immune), Commando (immune). Worst: SAM Site (/6),
