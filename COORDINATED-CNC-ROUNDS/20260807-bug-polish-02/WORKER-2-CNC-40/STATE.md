...
- Full-engine game tests completed: `6` (one base probe, one invalid changed harness run with material outcome evidence, two valid changed runs, two matched base controls)
