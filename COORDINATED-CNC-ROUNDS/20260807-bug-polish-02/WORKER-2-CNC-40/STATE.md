...
- Full-engine game tests completed: `8` (one base probe, one invalid changed harness run with material outcome evidence, three valid changed runs, three matched base controls; excluded two tick-0 map-bootstrap failures without game evidence)
