		...
		void IUtilityCommand.Run(Utility utility, string[] args)
		{
			...
			foreach (var d in rows)
			{
				...
				Console.WriteLine(string.Join("\t", d.Attacker, d.Defender, d.CanTarget, d.DefenderHitPoints, d.DefenderArmor,
					...
					F(d.DefenderHealingPerTick), F(d.TimeToKillTicks), F(d.RangeMultiplier), F(d.EffectiveDamagePerTick), F(d.KillRate),
